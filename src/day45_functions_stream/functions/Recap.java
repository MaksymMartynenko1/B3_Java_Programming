...
public class Recap {
    public static void main(String[] args) {
        ...
        System.out.println(verifyDuplicates.test(123456));  //false

        System.out.println(verifyDuplicates2.test(102341)); // true
        System.out.println(verifyDuplicates2.test(123456)); //false
